...
///
/// The `u63` type is contagious. Most operations on `u63` will return `u63`
///  values
class u63 extends unsigned {
  /// 63-bit Unsigned Integer
  ///
  /// `0` to `9223372036854775807`
  u63(int value) : super(value: value.toUnsigned(64));

  /// 63-bit Unsigned Integer
  ///
  /// `0` to `9223372036854775807`
  ///
  /// Create `u63` from another `integer` value
  u63.integer(integer val) : super(value: val.value.toUnsigned(64));
  ...
  /// u63(int.tryParse(const String.fromEnvironment(name, defaultValue: ""))
  ///     ?? defaultValue)
  /// ```
  /// Example:
  /// ```dart
  /// u63.fromEnvironment("defaultPort", defaultValue: 80)
  /// ```
  factory u63.fromEnvironment(String name, {int defaultValue = 0}) {
    return u63(
      int.fromEnvironment(
        name,
        defaultValue: defaultValue.toUnsigned(64),
      ),
    );
  }
  ...
  static u63? tryParse(String source) {
  ...
  /// Returns `u63`
  @override
  u63 operator *(dynamic other) {
    if (other is integer) {
      return u63(value * other.value);
    } else if (other is int) {
      return u63(value * other);
    } else if (other is double) {
      return u63((value * other).truncate());
    } else {
  ...
  /// `this`.
  @override
  u63 remainder(dynamic other) {
    if (other is integer) {
      return u63(value.remainder(other.value));
    } else if (other is int) {
      return u63(value.remainder(other));
    } else if (other is double) {
      return u63((value.remainder(other)).truncate());
    } else {
      throw Exception('Invalid type for operand: ${other.runtimeType}');
    }
  }
  ...
  @override
  u63 modPow(unsigned exponent, unsigned modulus) =>
  ...
  @override
  u63 modInverse(unsigned modulus) => u63(value.modInverse(modulus.value));

...
/// `-8` to `7`
///
/// The `i4` type is contagious. Most operations on `i4` will return `i4`
///  values
class i4 extends signed {
  /// 4-bit Signed Integer
  ///
  /// `-8` to `7`
  i4(int value) : super(value: value.toSigned(4));

  /// 4-bit Signed Integer
  ///
  /// `-8` to `7`
  ///
  /// Create `i4` from another `integer` value
  i4.integer(integer val) : super(value: val.value.toSigned(4));
  ...
  static i4? tryParse(String source) {
  ...
  @override
  i4 modPow(unsigned exponent, unsigned modulus) =>
  ...
  @override
  i4 modInverse(unsigned modulus) => i4(value.modInverse(modulus.value));
